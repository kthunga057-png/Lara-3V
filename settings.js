...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "CNx13YjD#k8P0tn8lzhp8PU3UOeMB3lBxEcUwgCcnnRMpHQumrW4", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94712429813",
DEV: process.env.DEV || "94712429813",
LANG: process.env.LANG || "EN", // EN | SI
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "false",
AUTO_STATUS_REACT: process.env.AUTO_STATUS_REACT || "false",
AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "false",
AUTO_BIO: process.env.AUTO_BIO || "falsee",
